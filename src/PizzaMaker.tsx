                ...
                <div className="divMaking">
                    ...
                    <div className="lineTwo">
                        ...
                        <div className="divFilling">
                                ...
                                <div className="filling plumSouse" onClick={() => addSouse(Souse.Plum)}>
                                ...
                                <div className="filling bbqSouse" onClick={() => addSouse(Souse.BBQ)}>
                    ...
                    <div className="lineTree">
                        ...
                        <div className="divFilling divFilling2">
