...
function CarouselMedia() {
    ...
    return(
        screenWidth <= 592 ?
            <Carousel minWidth={280} minHeight={200} images={["/imgAboutCompany/baner1.png", "/imgAboutCompany/baner2.png", "/imgAboutCompany/baner3.png"]} dots={false} autoScroll={false} left={true} right={true}/> :
        screenWidth <= 954 ?
